                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-xxl-2 col-xl-2 col-lg-6 col-md-6 col-sm-6 col-6">
                                <div className="header__left d-flex">
                                    <div className="logo">
                                        <Link href="/">
                                            <a>
                                                <img className="logo-white" src="assets/img/logo/kindy.png" alt="logo" />
                                                <img className="logo-black" src="assets/img/logo/kindy.png" alt="logo" />
                                            </a>
                                        </Link>
                                    </div>
                                </div>
                            ...
                            <div className="col-xxl-5 col-xl-5 d-none d-xl-block">
                                <div className="main-menu main-menu-3 d-none d-xl-block">
                                    <nav id="mobile-menu">
                                        <ul>
                                            <li className="">
                                                <Link href="/home-3"><a>Teacher's Home </a></Link>
                                            ...
                                            <li className="has-dropdown">
                                                <Link href="/blog"><a>Book</a></Link>
                                                <ul className="submenu">
                                                    <li><Link href="/blog"><a>Book details</a></Link></li>
                            ...
                            <div className="col-xxl-5 col-xl-5 col-lg-6 col-md-6 col-sm-6 col-6">
                              ...
                              <Link href="/home-2"><a className="e-btn">Log out</a></Link>
                                 </div>
